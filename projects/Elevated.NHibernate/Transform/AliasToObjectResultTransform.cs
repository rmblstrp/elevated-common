namespace NHibernate.Transform
{
	...
	public class AliasToObjectResultTransformer : IResultTransformer
	{
		...
		{
			return Equals(obj as AliasToObjectResultTransformer);
		}

		public bool Equals(AliasToObjectResultTransformer other)
		{
